...
channel=options.channel+"_HH_"+tauID+"_"+options.Bkg_mass_rand+"_"+options.variables+"_TEST"
...
def ReweightDataframe(data, channel, var_name):
...
if(do_2l_2tau_diagnostics == True):
    ...
    MakeTProfile(channel, data, "diHiggsMass", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "tau1_pt", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "met_LD", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "diHiggsVisMass", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "m_ll", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "tau2_pt", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "mTauTau", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "mT_lep1", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "mT_lep2", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "mht", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "met", 0., 1100., 1, True, "before")
    MakeTProfile(channel, data, "dr_lep_tau_min_SS", 0., 1.0, 1, True, "before")
    MakeTProfile(channel, data, "dr_lep_tau_min_OS", 0., 1.0, 1, True, "before")
    MakeTProfile(channel, data, "dr_taus", 0., 1.0, 1, True, "before")
    MakeTProfile(channel, data, "dr_lep1_tau1_tau2_min", 0., 1.0, 1, True, "before")
    MakeTProfile(channel, data, "dr_lep1_tau1_tau2_max", 0., 1.0, 1, True, "before")
    MakeTProfile(channel, data, "max_tau_eta", 0., 3.0, 1, True, "before")
    MakeTProfile(channel, data, "max_lep_eta", 0., 3.0, 1, True, "before")
    MakeTProfile(channel, data, "nElectron", 0., 3., 1, True, "before")
    MakeTProfile(channel, data, "nBJet_medium", 0., 3., 1, True, "before")
    MakeTProfile(channel, data, "dr_leps", 0., 1.0, 1, True, "before")
    MakeTProfile(channel, data, "tau1_eta", -3.0, 3.0, 1, True, "before")
    MakeTProfile(channel, data, "deltaEta_lep1_tau1", -5.0, 5.0, 1, True, "before")
    MakeTProfile(channel, data, "deltaEta_lep1_tau2", -5.0, 5.0, 1, True, "before")
    MakeTProfile(channel, data, "m_lep1_tau2", 0., 1100., 1, True, "before")
    ...
    ReweightDataframe(data, channel, "diHiggsMass")
    ReweightDataframe(data, channel, "tau1_pt")
    ReweightDataframe(data, channel, "met_LD")
    ReweightDataframe(data, channel, "diHiggsVisMass")
    ReweightDataframe(data, channel, "m_ll")
    ReweightDataframe(data, channel, "tau2_pt")
    ReweightDataframe(data, channel, "mTauTau")
    ReweightDataframe(data, channel, "mT_lep1")
    ReweightDataframe(data, channel, "mT_lep2")
    ReweightDataframe(data, channel, "mht")
    ReweightDataframe(data, channel, "met")
    ReweightDataframe(data, channel, "dr_lep_tau_min_SS")
    ReweightDataframe(data, channel, "dr_lep_tau_min_OS")
    ReweightDataframe(data, channel, "dr_taus")
    ReweightDataframe(data, channel, "dr_lep1_tau1_tau2_min")
    ReweightDataframe(data, channel, "dr_lep1_tau1_tau2_max")
    ReweightDataframe(data, channel, "max_tau_eta")
    ReweightDataframe(data, channel, "max_lep_eta")
    ReweightDataframe(data, channel, "nElectron")
    ReweightDataframe(data, channel, "nBJet_medium")
    ReweightDataframe(data, channel, "dr_leps")
    ReweightDataframe(data, channel, "tau1_eta")
    ReweightDataframe(data, channel, "deltaEta_lep1_tau1")
    ReweightDataframe(data, channel, "deltaEta_lep1_tau2")
    ReweightDataframe(data, channel, "m_lep1_tau2")
else:
...
if(do_2l_2tau_diagnostics == True):
    ...
    #data_new = data_odd.append(data_even, ignore_index=True) 
    #data_new.loc[data_new['target']==0, [weights]] *= 0.5
    #data_new.loc[data_new['target']==1, [weights]] *= 0.5
    #ReweightDataframe(data_new, channel, "diHiggsMass")
